...
public class EncoderDecoderProvider {
	...
	private static final ThreadLocal<Cipher> ENCRYPT_CIPHER = ThreadLocal
			.withInitial(() -> initCipher(Cipher.ENCRYPT_MODE));
	private static final ThreadLocal<Cipher> DECRYPT_CIPHER = ThreadLocal
			.withInitial(() -> initCipher(Cipher.DECRYPT_MODE));
